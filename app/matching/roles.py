...
FAMILY_SIGNS: dict[str, list[str]] = {
    "backend": ["backend", "back end", "back-end", "server side", "server-side", "מפתח שרת", "צד שרת"],
    "frontend": ["frontend", "front end", "front-end", "web developer", "ui developer", "react developer"],
    ...
    "data": ["data engineer", "data analyst", "data scientist", "analytics engineer", "bi developer",
             "big data", "data platform", "business intelligence"],
    "ml": ["machine learning", "ml engineer", "ai engineer", "deep learning", "nlp engineer",
           "computer vision", "algorithm engineer", "algorithms", "research engineer", "applied scientist"],
    "devops": ["devops", "sre", "site reliability", "infrastructure engineer", "platform engineer",
               "cloud engineer", "production engineer", "systems engineer"],
    "qa": ["qa engineer", "quality assurance", "test automation", "automation engineer", "sdet", "qa lead", "בדיקות תוכנה"],
    "security": ["security engineer", "cyber", "infosec", "appsec", "penetration", "security researcher"],
    "embedded": ["embedded", "firmware", "fpga", "rtos", "hardware engineer"],
    "software": ["software engineer", "software developer", "software architect", "programmer",
                 "מפתח", "מהנדס תוכנה", "developer"],
    "product": ["product manager", "product owner", "group product", "מנהל מוצר"],
    "design": ["ux designer", "ui designer", "product designer", "ux/ui", "graphic designer"],
    "management": ["engineering manager", "team lead", "team leader", "tech lead", "r&d manager",
                   "vp engineering", "vp r&d", "group manager", "director of engineering", "cto", "head of engineering"],
    "sales": ["sales", "account executive", "business development", "sdr", "bdr", "sales development"],
    "success": ["customer success", "account manager", "technical account", "support engineer",
                ...
                "professional services", "delivery manager", "customer support"],
    "marketing": ["marketing", "seo specialist", "growth", "content writer", "social media", "demand generation"],
    "finance": ["finance", "accountant", "controller", "fp&a", "bookkeeper"],
    "hr": ["recruiter", "talent acquisition", "people operations", "hr business", "hrbp", "sourcer"],
